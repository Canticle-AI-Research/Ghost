...
| Stage 1 evaluation candidate | `feat/stage1-frozen-evals`: 20 frozen cases, real-lifecycle BIL-0 smoke/verifier/gate, step ceiling, and initial clean-source baseline; repaired successor baseline pending |
